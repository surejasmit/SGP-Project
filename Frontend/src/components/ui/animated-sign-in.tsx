    ...
    <div className={`relative min-h-screen flex items-center justify-center overflow-hidden ${isDarkMode ? "bg-gray-900" : "bg-gradient-to-br from-blue-50 to-indigo-100"}`}>
      ...
      >
        <div className="text-center mb-8">
          <h1 className={`text-3xl font-bold mb-2 ${isDarkMode ? "text-white" : "text-gray-900"}`}>Welcome</h1>
          <p className={`${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Please sign in to continue</p>
        </div>
