    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-white mb-2">Issue Reported Successfully!</h2>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black pt-20 px-4 pb-8">
      <div className="max-w-2xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <Link href={isLab ? `/lab/${roomId.replace('lab-', '')}` : `/classroom/${roomId}`} className="px-4 py-2 text-gray-300 hover:text-white">
            ← Back
          </Link>
        </div>
        ...
        <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-8">
          <div className="mb-6">
            ...
            <p className="text-white text-xl font-semibold">{displayName} - {itemType} {itemNumber}</p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-gray-900 border border-gray-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-gray-400"
              />
            </div>
