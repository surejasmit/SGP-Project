    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black pt-20">
      <div className="relative h-[calc(100vh-5rem)] overflow-y-auto" ref={containerRef}>
        ...
        <div className="max-w-4xl mx-auto px-8 py-16">
          ...
          >
            <h1 className="text-5xl font-bold bg-gradient-to-r from-gray-200 to-gray-400 bg-clip-text text-transparent">
              About Us
            </h1>
          ...
          <div className="space-y-8 text-gray-300 leading-relaxed">
            ...
            >
              <p className="text-lg">
                Our <span className="text-blue-400 font-semibold">Smart Classroom & Lab Electronic Management System</span> is 
            ...
            >
              <p className="text-lg">
                ...
                built using modern web technologies like <span className="text-purple-400 font-semibold">React</span>, 
                <span className="text-blue-400 font-semibold"> TypeScript</span>, and 
                <span className="text-cyan-400 font-semibold"> Tailwind CSS</span>, providing a fast, reliable, 
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  <motion.div
                    ...
                    className="bg-gray-800/30 p-6 rounded-lg border border-gray-700 cursor-pointer"
                  >
        ...
        <div className="pointer-events-none fixed bottom-0 left-0 h-24 w-full bg-gradient-to-t from-gray-900 to-transparent" />
      </div>
    </div>
  );
}
